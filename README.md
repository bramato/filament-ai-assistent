...
use Bramato\FilamentAiAssistent\Models\User;
...
```bash
php artisan vendor:publish --provider="Bramato\FilamentAiAssistent\FilamentBlogServiceProvider" --tag=filament-blog-views
```
```bash
php artisan vendor:publish --provider="Bramato\FilamentAiAssistent\FilamentBlogServiceProvider" --tag=filament-blog-config
```
```bash
php artisan vendor:publish --provider="Bramato\FilamentAiAssistent\FilamentBlogServiceProvider" --tag=filament-blog-components
```
```bash
php artisan vendor:publish --provider="Bramato\FilamentAiAssistent\FilamentBlogServiceProvider" --tag=filament-blog-migrations
```
...
```php
use Bramato\FilamentAiAssistent\Blog;
...
use Bramato\FilamentAiAssistent\Traits\HasBlog;
